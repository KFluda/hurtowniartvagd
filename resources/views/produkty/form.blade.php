{{-- resources/views/produkty/form.blade.php --}}
<div class="row g-3">
    <div class="col-md-3">
    ...
    {{-- CENA NETTO + VAT --}}
    <div class="col-md-3">
        <label class="form-label">Cena netto (zł)</label>
        <input name="cena_netto" type="number" step="0.01" class="form-control"
               value="{{ old('cena_netto',$produkt->cena_netto ?? '') }}">
    </div>

    <div class="col-md-3">
        <label class="form-label">Stawka VAT (%)</label>
        <input name="stawka_vat" type="number" step="0.01" class="form-control"
               value="{{ old('stawka_vat',$produkt->stawka_vat ?? 23) }}">
    </div>
    ...
    <div class="col-md-4">
        ...
        <div class="mt-2">
            <small class="text-muted d-block">Aktualne zdjęcie:</small>
            <img src="{{ asset('storage/products/'.$produkt->image) }}"
